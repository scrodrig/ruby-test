...
RSpec.describe ExamplesController, type: :controller do
  ...
  let(:valid_attributes) {
    {"id"=> 1, "created_at" => "2016-05-24 10:23:54", "updated_at" => "2016-05-24 10:23:54"}
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates and gets a new Example" do
        ...
        get :show, params: valid_attributes #{id: valid_attributes}
        expect(response).to be_success
      end

      it "renders a JSON response with the new example" do
        post :create, params: {example: valid_attributes}
  ...
  #     it "renders a JSON response with errors for the example" do
  #       example = Example.create! valid_attributes
  #
